...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '26px 16px 20px', overflow: 'hidden' }}>
        <div
          ...
          style={{
            ...
            color: 'rgba(255,255,255,0.2)', marginBottom: 8, whiteSpace: 'nowrap',
          }}
        >
          Solnova Lab
        </div>
          ...
          <div style={{
            ...
            <svg width="9" height="9" viewBox="0 0 9 9" fill="none">
              <rect x="1" y="1" width="7" height="7"
                ...
                fill="none" transform="rotate(45 4.5 4.5)" />
            </svg>
          </div>
          <span
            className="sidebar-label"
            style={{ fontSize: 15, fontWeight: 300, color: 'rgba(255,255,255,0.7)', letterSpacing: '0.06em', whiteSpace: 'nowrap' }}
          >
            Twin
          </span>
        </div>
      ...
      <nav style={{ flex: 1, padding: '4px 0', overflowY: 'auto' }}>
        {NAV.map(({ href, label, sub, icon }, i) => {
          ...
          return (
            ...
            >
              <div style={{
                position: 'absolute', left: -8, top: '20%', height: '60%', width: 2.5,
                borderRadius: 2,
              ...
              <span style={{
                ...
                flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', width: 18,
              }}>
                {icon}
              </span>
              <div className="sidebar-label" style={{ overflow: 'hidden', whiteSpace: 'nowrap' }}>
                ...
                <div style={{ fontSize: 9, color: active ? 'rgba(255,255,255,0.45)' : 'rgba(255,255,255,0.16)', letterSpacing: '0.08em', marginTop: 2 }}>
                  {sub}
                </div>
              </div>
            </Link>
      ...
      >
        <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.14)', letterSpacing: '0.2em', textTransform: 'uppercase' }}>SUST v0.3</div>
        <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.08)', marginTop: 3 }}>Aggregator · 11 apps</div>
      </div>
    </aside>
  )
}
