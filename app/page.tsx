...
// TODO: 本番ドメインに更新。設定せず訪れるとリンク先がプレースホルダになるだけ
// 各サテライトアプリの本番URLをここに記載する
const APPS = [
  { id: 'resonance',         label: 'resonance',         desc: '感情パターン',           color: '#ef4444', url: 'https://resonance-tan.vercel.app' },
  { id: 'feelings',          label: 'feelings',          desc: '感情の自由記述',         color: '#f97316', url: 'https://feelings.vercel.app' },
  ...
  { id: 'minus',             label: 'minus',             desc: '手放す',                 color: '#06b6d4', url: 'https://minus.vercel.app' },
  { id: 'gap',               label: 'gap',               desc: '言いたいこと',           color: '#6366f1', url: 'https://gap.vercel.app' },
  { id: 'evolve',            label: 'evolve',            desc: '成長の記録',             color: '#a855f7', url: 'https://evolve.vercel.app' },
  { id: 'narrative',         label: 'narrative',         desc: '今の自分を一文で',     color: '#ec4899', url: 'https://narrative.vercel.app' },
  { id: 'atlas',             label: 'atlas',             desc: '感受性を記録 (HSP-8)',     color: '#f59e0b', url: 'https://atlas.vercel.app' },
  { id: 'lie',               label: 'lie',               desc: 'ついた嘘を振り返る',   color: '#64748b', url: 'https://lie.vercel.app' },
]
